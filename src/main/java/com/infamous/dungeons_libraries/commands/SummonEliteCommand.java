...
public class SummonEliteCommand {
   ...
   private static final SimpleCommandExceptionType INVALID_POSITION = new SimpleCommandExceptionType(Component.translatable("commands.summonelite.invalidPosition"));
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_138815_, CommandBuildContext p_250122_) {
      p_138815_.register(Commands.literal("summonelite").requires((p_138819_) -> {
         return p_138819_.hasPermission(2);
      }).then(Commands.argument("entity", ResourceArgument.resource(p_250122_, Registries.ENTITY_TYPE)).suggests(SuggestionProviders.SUMMONABLE_ENTITIES).executes((p_138832_) -> {
         return spawnEntity(p_138832_.getSource(), ResourceArgument.getSummonableEntityType(p_138832_, "entity"), p_138832_.getSource().getPosition(), new CompoundTag(), true);
      }).then(Commands.argument("pos", Vec3Argument.vec3()).executes((p_138830_) -> {
         return spawnEntity(p_138830_.getSource(), ResourceArgument.getSummonableEntityType(p_138830_, "entity"), Vec3Argument.getVec3(p_138830_, "pos"), new CompoundTag(), true);
      }).then(Commands.argument("nbt", CompoundTagArgument.compoundTag()).executes((p_138817_) -> {
         return spawnEntity(p_138817_.getSource(), ResourceArgument.getSummonableEntityType(p_138817_, "entity"), Vec3Argument.getVec3(p_138817_, "pos"), CompoundTagArgument.getCompoundTag(p_138817_, "nbt"), false);
      })))));
   }

   private static int spawnEntity(CommandSourceStack p_138821_, Holder.Reference<EntityType<?>> p_138822_, Vec3 p_138823_, CompoundTag p_138824_, boolean p_138825_) throws CommandSyntaxException {
      BlockPos blockpos = new BlockPos((int) p_138823_.x, (int) p_138823_.y, (int) p_138823_.z);
