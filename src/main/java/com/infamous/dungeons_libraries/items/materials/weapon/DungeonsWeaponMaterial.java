...
public class DungeonsWeaponMaterial implements Tier {
    ...
    public static final Codec<Tier> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            TagKey.codec(Registries.BLOCK).fieldOf("level").forGetter(iItemTier -> ((DungeonsWeaponMaterial) iItemTier).getIncorrectBlocksForDrops())
    ...
    public DungeonsWeaponMaterial(String name, Holder<SoundEvent> equipSound, int durability, int enchantability, ResourceLocation repairItemResourceLocation, float attackSpeed, float attackDamageBonus, TagKey<Block> level) {
        this.name = name;
