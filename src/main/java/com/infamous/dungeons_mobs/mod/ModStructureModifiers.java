...
public class ModStructureModifiers {
    ...
    public static final DeferredRegister<MapCodec<? extends StructureModifier>> STRUCTURE_MODIFIER_SERIALIZERS = DeferredRegister.create(NeoForgeRegistries.Keys.STRUCTURE_MODIFIER_SERIALIZERS, DungeonsMobs.MODID);

    /**
     * Stock structure modifier for adding mob spawns to structures.
     */
    public static final Supplier<MapCodec<DungeonsMobsStructureModifiers.AddSpawnsStructureModifier>> ADD_SPAWNS_STRUCTURE_MODIFIER_TYPE = STRUCTURE_MODIFIER_SERIALIZERS.register("add_spawns", () ->
            RecordCodecBuilder.mapCodec(builder -> builder.group(
                    ...
                    new EitherMapCodec<>(MobSpawnSettings.SpawnerData.CODEC.listOf().fieldOf("structures"), MobSpawnSettings.SpawnerData.CODEC.fieldOf("structures")).xmap(
     ...
     */
    public static final Supplier<MapCodec<DungeonsMobsStructureModifiers.RemoveSpawnsStructureModifier>> REMOVE_SPAWNS_STRUCTURE_MODIFIER_TYPE = STRUCTURE_MODIFIER_SERIALIZERS.register("remove_spawns", () ->
            RecordCodecBuilder.mapCodec(builder -> builder.group(
