...
public class ShieldAndMeleeAttackGoal<T extends PathfinderMob & IShieldUser> extends MeleeAttackGoal {
    ...
    private boolean hasShieldInOffhand() {
        return this.hostCreature.getOffhandItem().canPerformAction(net.neoforged.neoforge.common.ItemAbilities.SHIELD_BLOCK); // using the Forge ItemStack-sensitive version
    }
