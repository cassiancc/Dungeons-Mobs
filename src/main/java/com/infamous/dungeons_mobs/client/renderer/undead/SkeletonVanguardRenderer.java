...
public class SkeletonVanguardRenderer extends DynamicGeoEntityRenderer<SkeletonVanguardEntity> {
    ...
    @Override
    protected void applyRotations(SkeletonVanguardEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, SkeletonVanguardEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
