...
public class IceologerArmorGearRenderer extends ArmorGearRenderer<IceologerArmorGear> {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, IceologerArmorGear animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
