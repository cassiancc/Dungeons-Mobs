...
public class WildfireRenderer extends DynamicGeoEntityRenderer<WildfireEntity> {
    ...
    @Override
    protected void applyRotations(WildfireEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
...
//
//    @Override
//    public void renderRecursively(PoseStack poseStack, WildfireEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
