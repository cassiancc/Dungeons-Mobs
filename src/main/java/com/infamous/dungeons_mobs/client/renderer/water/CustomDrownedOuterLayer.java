...
public class CustomDrownedOuterLayer<T extends Drowned> extends RenderLayer<T, DrownedModel<T>> {
    private static final ResourceLocation DROWNED_OUTER_LAYER_LOCATION = GeneralUtil.loc("textures/entity/zombie/drowned_outer_layer.png");
    private static final ResourceLocation SEAWEED_ARMORED_DROWNED_OUTER_LAYER_LOCATION = GeneralUtil.mobsLoc( "textures/entity/ocean/seaweed_armored_drowned_outer_layer.png");
    private static final ResourceLocation PALE_ARMORED_DROWNED_OUTER_LAYER_LOCATION = GeneralUtil.mobsLoc( "textures/entity/ocean/pale_armored_drowned_outer_layer.png");
