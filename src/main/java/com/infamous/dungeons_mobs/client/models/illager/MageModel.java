...
public class MageModel extends GeoModel<MageEntity> {
    ...
    @Override
    public void setCustomAnimations(MageEntity entity, long uniqueID, AnimationState<MageEntity> customPredicate) {
