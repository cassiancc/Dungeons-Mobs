...
public class GeomancerStaffItem extends ArtifactItem implements IHasInventorySprite {
    ...
    public InteractionResultHolder<ItemStack> procArtifact(ArtifactUseContext c) {
        ...
        itemstack.hurtAndBreak(1, (ServerLevel) playerIn.level(), playerIn, (entity) -> PacketDistributor.sendToPlayersTrackingEntityAndSelf(playerIn, new BreakItemMessage(playerIn.getId(), itemstack)));
