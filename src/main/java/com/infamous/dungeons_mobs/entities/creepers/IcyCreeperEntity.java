...
public class IcyCreeperEntity extends Creeper {
    ...
    private void explodeCreeper() {
        if (!this.level().isClientSide) {
            Level.ExplosionInteraction explosion$mode = net.neoforged.neoforge.event.EventHooks.canEntityGrief(this.level(), this) ? Level.ExplosionInteraction.MOB : Level.ExplosionInteraction.NONE;
